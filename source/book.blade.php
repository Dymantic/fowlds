...
<section class="py-28 px-8">
    ...
    <img src="/assets/images/home/book_rewilding.jpg" alt="Book cover for Rewilding Africa by Grant Fowlds and Graham Spence" class="block my-20 mx-auto max-w-lg">
