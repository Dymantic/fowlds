<section class="flex flex-col md:flex-row justify-between py-20 mx-auto max-w-lg">
    <div class="w-full md:w-1/2 px-8">
        <p class="h1 mb-8">Introduction.</p>
        <p class="mb-8">
    ...
    <div class="w-full md:w-1/2 px-8 md:pl-8 md:pr-0 mt-8 md:mt-0 hidden flex items-center">
        <img src="/assets/images/grant_fowlds_introduction.jpg" alt="Grant Fowlds">
    </div>
</section>